...
const donationPresets = [200000, 500000, 1000000, 2000000];
...
const DonateInner = () => {
  const fallbackProgram = danaSosialPrograms[0];
            ...
            <div className='cm-details__content'>
              <div className='cm-group' data-aos='fade-up' data-aos-duration={1000}>
                ...
                <p>
                  ...
                  santunan kesehatan anggota. PPSI Digjaya memastikan penyaluran dana dilakukan secara
                  transparan dengan laporan berkala kepada perguruan.
                </p>
              </div>
                  ...
                  <form className='donation-form' onSubmit={handleSubmit}>
                    ...
                    <div className='donation-form__single'>
                      <div className='donation-form__single-intro'>
                        ...
                        <p className='info'>
                          Minimal Rp50.000. Anda dapat menyesuaikan angka sesuai kebutuhan program.
                        </p>
                      </div>
              ...
              >
                ...
                <p>
                  ...
                  penggunaan dana dan perkembangan atlet. Hubungi sekretariat untuk informasi lebih
                  lanjut.
                </p>
          ...
          <div className='col-12 col-xl-4'>
            <div className='cm-details__sidebar'>
              ...
              >
                ...
                <p>
                  Kirim bukti transfer dan laporan penggunaan dana ke sekretariat untuk verifikasi dan
                  pembaruan dashboard perguruan.
                </p>
                <ul className='training__list'>
