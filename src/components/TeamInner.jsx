          ...
          <div className='col-12 col-sm-6 col-xl-3'>
            ...
            >
              <div className='team__single van-tilt'>
                <div className='team__single-thumb'>
                  <Link href='/team-details'>
                    <OptimizedImage src='assets/images/team/eight.png' alt='Image_inner' />
                  </Link>
                  <div className='team__icons'>
                    <div className='team__single-content__icon'>
                      <i className='fa-solid fa-plus' />
          ...
          <div className='col-12 col-sm-6 col-xl-3'>
            ...
            >
              <div className='team__single van-tilt'>
                <div className='team__single-thumb'>
                  <Link href='/team-details'>
                    <OptimizedImage src='assets/images/team/nine.png' alt='Image_inner' />
                  </Link>
                  <div className='team__icons'>
                    <div className='team__single-content__icon'>
                      <i className='fa-solid fa-plus' />
          ...
          <div className='col-12 col-sm-6 col-xl-3'>
            ...
            >
              <div className='team__single van-tilt'>
                <div className='team__single-thumb'>
                  <Link href='/team-details'>
                    <OptimizedImage src='assets/images/team/ten.png' alt='Image_inner' />
                  </Link>
                  <div className='team__icons'>
                    <div className='team__single-content__icon'>
                      <i className='fa-solid fa-plus' />
